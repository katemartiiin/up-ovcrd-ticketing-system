...
class UserController extends Controller
{
    ...
    {
        $admin = Admin::with('office')->withTrashed()->findOrFail($id);
    ...
    public function edit($id)
    {
        $offices = Office::all();
        $roles = Role::all();
        $admin = Admin::with('office')->findOrFail($id);
    ...
    public function restore(string $id)
    {
        ...
        ActivityLog::create([
            'user_id' => auth()->user()->id,
            'type' => Admin::class,
            'action' => 'You restored a user account (#'. $user->id.').'
        ]);

        return response()->json([
            'message' => 'User #' . $id . ' was successfully restored.'
        ]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        ActivityLog::create([
            'user_id' => auth()->user()->id,
            'type' => Admin::class,
            'action' => 'You removed a user account (#'. $id.').'
        ]);
