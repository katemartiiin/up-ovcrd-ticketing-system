        ...
        <div class="min-h-screen w-full flex flex-wrap">
            ...
            <div class="w-1/6 md:block hidden shadow-lg">
                ...
                <div class="bg-up-maroon min-h-screen">
                    <div class="my-3">
                        <NavLink :href="route('vcd.dashboard')" :active="route().current('vcd.dashboard')">
                        ...
                        <NavLink :href="route('vcd.reports.index')" :active="route().current('vcd.reports.index')">
                            <div class="w-full flex">
                                <div class="w-1/4">
                                    <font-awesome-icon icon="fa-solid fa-chart-bar" />
                                </div>
                                <div class="3/4">Reports</div>
                            </div>
                        </NavLink>
                        <NavLink :href="route('vcd.tickets.index')" :active="route().current('vcd.tickets.index') || route().current('vcd.tickets.show')">
                            <div class="w-full flex">
                                <div class="w-1/4">
                        ...
                        <a href="https://docs.google.com/presentation/d/1v9Kzvg7wny5VrGhSxHc9O3zebHUF0wbmISKuB6fS3OE/edit#slide=id.g2b835489b3a_0_45" class="w-full uppercase inline-flex items-center px-10 py-7 font-medium leading-5 text-white hover:bg-up-maroon-lighter focus:outline-none transition duration-150 ease-in-out" target="_blank">
                            <div class="w-full flex">
                                <div class="w-1/4">
            ...
            <div class="md:w-5/6 w-full bg-gray-100">
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('vcd.dashboard')" :active="route().current('vcd.dashboard')">
                            Dashboard
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('vcd.reports.index')" :active="route().current('vcd.reports.index')">
                            Reports
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('vcd.tickets.index')" :active="route().current('vcd.tickets.index') || route().current('vcd.tickets.show')">
                            Tickets
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('vcd.notifications.index')"> Notifications </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('admin.logout', 'vcd')" method="post" as="button">
                                Log Out
                            </ResponsiveNavLink>
                        </div>
                    </div>
                ...
                <div class="w-full my-auto">
                    <div class="py-5 md:flex hidden justify-end items-end md:pr-10 bg-oblation-header">
                        <Link :href="route('vcd.notifications.index')" class="mr-3 text-up-maroon-darker hover:text-white m-auto transition duration-200 ease-in-out text-center"><font-awesome-icon icon="fa-solid fa-bell" /></Link>
                        <!-- Settings Dropdown -->
                        <div class="ml-3 relative">
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <DropdownLink :href="route('admin.logout', 'vcd')" method="post" as="button">
                                        Log Out
                                    </DropdownLink>
                                </template>
                            </Dropdown>
                    ...
                    <div class="mt-3 md:px-10 px-5">
                        <div class="w-full flex flex-wrap">
                            <div class="md:w-1/2 w-full md:mt-0 mt-3">
                                <h1 v-if="route().current('vcd.dashboard')" class="text-3xl mt-5">Welcome back, <span class="font-bold text-up-maroon">{{ $page.props.auth.user.name }}</span>!</h1>
                                <!-- Page Heading -->
