            ...
            <div class="w-1/6 md:block hidden shadow-lg">
                ...
                <div class="bg-up-maroon min-h-screen">
                    <div class="my-3">
                        ...
                        <NavLink :href="route('staff.tickets.index')" :active="route().current('staff.tickets.index') || route().current('staff.tickets.show')">
                            <div class="w-full flex">
                                <div class="w-1/4">
                        ...
                        <NavLink :href="route('admin.logout', 'staff')" method="post" as="button" class="px-3">
                            <div class="w-full flex">
                                <div class="w-1/4">
            ...
            <div class="md:w-5/6 w-full bg-gray-100">
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('staff.tickets.index')" :active="route().current('staff.tickets.index') || route().current('staff.tickets.show')">
                            Tickets
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('staff.notifications.index')"> Notifications </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('admin.logout', 'staff')" method="post" as="button">
                                Log Out
                            </ResponsiveNavLink>
                        </div>
                    </div>
                ...
                <div class="w-full my-auto">
                    <div class="py-5 md:flex hidden justify-end items-end md:pr-10 bg-oblation-header">
                        <Link :href="route('staff.notifications.index')" class="mr-3 text-up-maroon-darker hover:text-white m-auto transition duration-200 ease-in-out text-center"><font-awesome-icon icon="fa-solid fa-bell" /></Link>
                        <!-- Settings Dropdown -->
                        <div class="ml-3 relative">
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <DropdownLink :href="route('admin.logout', 'staff')" method="post" as="button">
                                        Log Out
                                    </DropdownLink>
                                </template>
                            </Dropdown>
                    ...
                    <div class="mt-3 md:px-10 px-5">
                        <div class="w-full flex flex-wrap">
                            <div class="md:w-1/2 w-full md:mt-0 mt-3">
                                <h1 v-if="route().current('staff.dashboard')" class="text-3xl mt-5">Welcome back, <span class="font-bold text-up-maroon">{{ $page.props.auth.user.name }}</span>!</h1>
                                <!-- Page Heading -->
