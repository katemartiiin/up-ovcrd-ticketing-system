...
export default {
    ...
    setup() {
        const { fetch, remove, restore } = useUsers()
        ...
        <div class="py-5 px-5 md:px-10">
            ...
            <div class="w-full flex flex-wrap text-sm">
                ...
                <div class="w-full md:w-1/3 py-1 flex grid grid-cols-3 gap-2 pl-2">
                    ...
                    <Link :href="route('admin.users.create')" class="bg-blue-600 border border-blue-700 hover:bg-blue-700 text-white font-semibold py-2 px-10 rounded-md transition duration-300 ease-in-out text-center">Create</Link>
                </div>
            </div>
            <!-- End of Search bar -->
                            ...
                            <template v-for="(header, key) in headers" :key="key" class="w-full flex flex-wrap">
                                ...
                                <div v-else class="w-1/2 bg-white p-2">
                                    <template v-if="item.deleted_at">
                                        ...
                                        <button type="button" @click="restoreUser(item.id)">
